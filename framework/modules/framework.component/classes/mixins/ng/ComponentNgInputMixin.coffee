# @di
di.provider 'ComponentNgInputMixin', (MixinAbstract, debug, ComponentNgInjectMixin, UnitInitMixin, UnitApplyMixin, ComponentNgDescriptorMixin, UnitMixin) ->
  log = debug.ns 'ComponentNgInputMixin'

  class ComponentNgInputMixin extends MixinAbstract

    @dependencies ComponentNgInjectMixin, UnitInitMixin, UnitApplyMixin, ComponentNgDescriptorMixin
    ...
    _init: ->
      ComponentNgInputMixin.super @, '_init'
